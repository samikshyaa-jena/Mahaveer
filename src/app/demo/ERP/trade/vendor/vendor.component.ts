...
export class VendorComponent implements OnInit {
  ...
  add_Vendor = () =>{
    ...
    this.ErpService.post_Reqs(erp_all_api.urls.add_trd_vendor, reqBody).pipe(finalize(() => {this.loader = false;})).subscribe(
      (res: any) =>{
        this.getVendorData = [];
        this.get_Vendor();
        this.hide_AddVendor();
  ...
  update_vendor = () =>{
    ...
    this.ErpService.post_Reqs(erp_all_api.urls.update_trd_vendor, reqBody).pipe(finalize(() => {this.loader = false;})).subscribe(
      (res: any) =>{
        this.get_Vendor();
        Notiflix.Report.success(res.msg, '', 'Close');;
  ...
  delete_vendor = () =>{
    ...
    this.ErpService.post_Reqs(erp_all_api.urls.delete_trd_vendor, reqBody).pipe(finalize(() => {this.loader = false;})).subscribe(
      (res: any) =>{
        this.getVendorData = [];
        this.get_Vendor();
        Notiflix.Report.success(res.msg, '', 'Close');;
