...
export class PurchaseComponent implements OnInit {
  ...
  get_purchase_details = () => {
    ...
    this.ErpService.get_Reqs(erp_all_api.urls.purchase_entry, { headers: headers }).pipe(finalize(() => { })).subscribe(
      (res: any) => {
        console.log(res);
  ...
  update_debit_note = () =>{
    ...
    this.ErpService.post_Reqs(erp_all_api.urls.debit_note, reqBody, { headers: headers }).pipe(finalize(() => { this.loader = false; })).subscribe(
      (res: any) => {
  ...
  update_purchase_details = () => {
    ...
    this.ErpService.post_Reqs(erp_all_api.urls.update_purchase_entry, reqBody, { headers: headers }).pipe(finalize(() => { this.loader = false; })).subscribe(
      (res: any) => {
