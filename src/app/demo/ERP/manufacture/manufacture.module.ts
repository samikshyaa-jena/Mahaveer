...
@NgModule({
  declarations: [CategoryComponent, VendorComponent, PurchaseComponent, StockComponent, ProductComponent, PurchaseAddComponent, DebitNoteComponent, ReqEntryComponent, ReqEditComponent, AddProductionComponent, ScrapComponent, ScrapConsumptionComponent, ProdEntryComponent],
  imports: [
    CommonModule,
